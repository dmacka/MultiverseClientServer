...
<tr>
<!--
  <td bgcolor="black" height="100" valign="top">
    <a href="test.jsp"><img src="images/logo.gif" alt="Multiverse Logo" border="0"></a>
  </td>
-->
...
<!--
     <tr>
       <td align="left" class="mvremember">

     <a target="multiverse" href="http://www.multiverse.net/consumer/registration.jsp?cid=0&scid=2">Sign up</a> 
     for a free Multiverse account.<br><br>
    Oops! <a target="multiverse" href="http://www.multiverse.net/consumer/forgot.jsp">I forgot my password.</a>
     </td>
...
<!--
<div class="mvcopyright">
<a target="multiverse" href="http://PRIVACYPOLICYLINK">Privacy Policy</a> |
<a target="multiverse" href="http://TERMSOFUSELINK">Terms of Use</a> |
Copyright &copy; COPYRIGHTYEAR COPYRIGHTCOMPANY All rights reserved.</div>
-->
