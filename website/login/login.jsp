...
<form action="#" id="login_form" method="post" onSubmit="return false;">
  <table class="form-noindent"  cellpadding="3" cellspacing="3" align="center" border=0 id="inner_login_table">
    <tr>
      ...
      <td> <input id="account" type="text" name="account" class="mvvalue"> </td>        
    </tr>
    
    <tr>
      <td width="100"> <span class="mvlabel">Password:</span> </td>

      <td> <input id="password" type="password" name="password" class="mvvalue"> </td>
    </tr>
    ...
    <tr id="world_section">
      ...
      <option value="sampleworld">Sample World</option>
  ...
  <!-- end inner login table -->
    ...
    <br><br>
    <!-- Table for status and errors: replaces pop count if there is an err or status message -->
<!--
    <table cellpadding="2" cellspacing="0" align="center" border="0" id="status_error_table" width=340px>
