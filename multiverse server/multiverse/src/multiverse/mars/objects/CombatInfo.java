...
public class CombatInfo extends Entity implements Runnable, Cooldown.CooldownObject {
    ...
    protected Map<String, Cooldown.State> cooldownMap = new HashMap<>();
    ...
    public ArrayList<String> getAbilities() { return new ArrayList<>(abilities); }
    ...
    public Set<EffectState> getEffects() { return new HashSet<>(effects); }
    public void setEffects(Set<EffectState> effects) { this.effects = new HashSet<>(effects); }
    protected Set<EffectState> effects = new HashSet<>();
