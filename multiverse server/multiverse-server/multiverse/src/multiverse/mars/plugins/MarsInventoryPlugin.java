...
public class MarsInventoryPlugin extends InventoryPlugin implements MessageCallback {
    ...
    public static void sendTradeOfferUpdate(Long trader1, Long trader2, TradeSession tradeSession) {
        ...
        LinkedList<?> offer1 = sendTradeOfferUpdateHelper(trader1, tradeSession);
        LinkedList<?> offer2 = sendTradeOfferUpdateHelper(trader2, tradeSession);
    ...
    protected static LinkedList<?> sendTradeOfferUpdateHelper(Long traderOid, TradeSession tradeSession) {
        LinkedList<Object> offer = new LinkedList<>();
    ...
    Map<Long, TradeSession> tradeSessionMap = new HashMap<>();
     ...
     */
    @Override
    public boolean equipItem(MVObject itemObj, Long activatorOid, boolean replace) {
    ...
    public static class EquipMap implements Serializable {
        ...
        HashMap<MarsEquipSlot, Long> map = new HashMap<>();
    ...
    Map<Long, DisplayContext> baseDCMap = new HashMap<>();
