...
public class MarsAbility {
    ...
    protected Map<String, Cooldown> cooldownMap = new HashMap<>();
	...
	try {
	    lock.lock();
	    return new ArrayList<>(reagentList);
	}
	finally {
	    lock.unlock();
	}
	...
	try {
	    lock.lock();
	    this.reagentList = new ArrayList<>(reagentList);
	}
	finally {
	    lock.unlock();
	}
    }
    protected ArrayList<String> reagentList = new ArrayList<>();
    ...
    protected ArrayList<String> toolList = new ArrayList<>();
