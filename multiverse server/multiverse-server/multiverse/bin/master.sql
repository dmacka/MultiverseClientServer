...
-- create accounts
insert into account (username, password, activated, suspended) values ("dave", "test", 1 , 0);
...
insert into world (dev_id, world_name, server_name, server_port, patcher_URL, media_URL) 
    values (1, "mv_fantasy", "192.168.1.6", 5040, "http://192.168.1.6/patcher/world_patcher.html", "http://192.168.1.6/sampleworld/update/");
