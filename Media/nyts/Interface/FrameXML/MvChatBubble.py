...
def ObjectAddedHandler(worldObj):
    if worldObj.ObjectType == ClientAPI.WorldObject.WorldObjectType.User or (worldObj.ObjectType == ClientAPI.WorldObject.WorldObjectType.Npc and worldObj.Name != "Pedestrian"):
