...
class SampleCharacterCreationContext(CharacterCreation.CharacterCreationContext):
    ...
    def __init__(self):
        ...
        self._female_models = [ 'human_female.mesh' ]
        # put some initial data in the create context, so that when we change attributes, we have a valid starting point
        self.SetAttributes("characterName", {"characterName":"", "model":"human_male.mesh", "sex":"male", "strength":"60", "dexterity":"60", "wisdom":"60", "intelligence":"60", "level":"1", "class":"Soldier"})
