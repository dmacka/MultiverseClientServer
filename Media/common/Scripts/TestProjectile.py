...
class TestProjectile:
    ...
    def ExecuteEffect(self, targetOID, sourceOID):
        ...
        # this is the name of the attachment point on the target that the
        #  projectile will hit
        ...
        # attach particle effect to caster's hand
        ...
        ClientAPI.DebugWrite('Finished projectile effect')
        
    def targetMoveHandler(self, position, orientation, scale):
        self.targetKeyFrame.Translate = position
    
# register the effect
ClientAPI.World.RegisterEffect("TestProjectile", TestProjectile)
