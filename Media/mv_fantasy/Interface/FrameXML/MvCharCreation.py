...
createContext = FantasyCharacterCreation.FantasyCharacterCreationContext()
selectContext = FantasyCharacterCreation.FantasyCharacterSelectionContext()
...
#    ClientAPI.Write("character name : '%s'" % characterNameString)
    ...
    try:
        ...
        ClientAPI.Log("Create call returned: " + str(entry))
    except Exception, e:
        errorMessage = "Exception thrown in CreateCharacter: %s" % str(e)
...
#    ClientAPI.Write("play")
    ...
    try:
        ...
        ClientAPI.LogError("Exception in MvCharCreation.MvCharSelectionPlay_OnClick: " + str(e))
